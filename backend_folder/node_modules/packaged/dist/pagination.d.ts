declare const PAGINATION_TYPES: readonly ["cursor", "offset"];
...
export type PaginationRequest = CursorBasedPaginationRequest | OffsetBasedPaginationRequest;
...
export type PaginationResponse = CursorBasedPaginationResponse | OffsetBasedPaginationResponse;
export {};
