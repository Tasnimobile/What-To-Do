...
declare const RESPONSE_STATUSES: readonly ["success", "error"];
...
export type SuccessResponse<TPayload = void> = TPayload extends void ? BaseSuccessResponse : SuccessResponseWithPayload<TPayload>;
...
export type ErrorResponse<TError = void> = TError extends void ? BaseErrorResponse : ErrorResponseWithPayload<TError>;
