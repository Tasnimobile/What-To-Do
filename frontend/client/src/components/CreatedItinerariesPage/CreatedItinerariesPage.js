...
function CreatedItinerariesPage({ onBack, user, onNavigateToProfile, onNavigateToHome, onViewItinerary, onNavigateToCreate }) {
    ...
    const CreatedItinerariesSidebar = () => {
        ...
        const handleItineraryClick = (itineraryId) => {
            const itinerary = filteredItineraries.find(item => item.id === itineraryId);
            if (itinerary) {
                            ...
                            <div className="itinerary-header">
                                ...
                                <div className="rating">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <span
                                            key={star}
                                            className={star <= (itinerary.rating || 0) ? "star filled" : "star"}
                                        >
                                            ★
                                        </span>
                                    ))}
                    ...
                    <div className="filter-modal-overlay">
                        <div className="filter-modal">
                            <div className="filter-modal-header">
                                ...
                                <button className="close-btn" onClick={handleCloseFilter}>×</button>
                            </div>
                            ...
                            <div className="filter-sections">
                                ...
                                <div className="filter-section">
                                    ...
                                    <div className="tags-filter">
                                        {['park', 'outdoors', 'family', 'food', 'cultural', 'walking', 'museums', 'educational', 'indoor'].map(tag => (
                                            <button
                                                key={tag}
                                    ...
                                    <div className="duration-filter">
                                        {[
                                            ...
                                            <button
                                                ...
                                                onClick={() => setFilters(prev => ({ ...prev, maxDuration: option.value }))}
                                            >
                                                {option.label}
                                            </button>
                                        ))}
                                    ...
                                    <div className="price-filter">
                                        {[
                                            ...
                                            <button
                                                ...
                                                onClick={() => setFilters(prev => ({ ...prev, maxPrice: option.value }))}
                                            >
                                                {option.label}
                                            </button>
                                        ))}
