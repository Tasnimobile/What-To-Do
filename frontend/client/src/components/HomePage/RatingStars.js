  ...
  return (
    <div className="rating-stars-container">
      ...
      <div className="rating-section">
        ...
        <div className="stars">{renderStars(userRating, canRate)}</div>
        {userRating > 0 && <span className="rating-value">({userRating})</span>}
      </div>
      ...
      {!canRate && (
        <div className="rating-notice">You can't rate your own itineraries</div>
      )}
    </div>
  );
}
