    ...
    try {
      ...
      if (savedItineraries) {
        ...
        const defaultItineraries = [
          {
            ...
            rating: 5,
            description:
              "A perfect day exploring Central Park's hidden gems and main attractions",
          ...
          },
          {
            ...
            rating: 4,
            description:
              "Culinary adventure through Brooklyn's best eateries and food markets",
          ...
          },
          {
            ...
            rating: 3,
            description:
              "Explore NYC's world-class museums and cultural institutions",
        ...
        localStorage.setItem(
          "userItineraries",
          JSON.stringify(defaultItineraries)
        );
      }
    } catch (error) {
