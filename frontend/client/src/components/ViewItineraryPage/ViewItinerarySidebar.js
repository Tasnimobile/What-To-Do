        ...
        <div className="view-itinerary-sidebar">
            ...
            <div className="create-form-card">
                ...
                <div className="form-section">
                    <div className="input-group">
                        <div className="view-field">
                            <label className="form-label">Destinations ({destinations.length})</label>
                            {destinations.length > 0 ? (
                                <div className="destinations-list">
                                    {destinations.map((destination, index) => (
                                        <div key={destination.id || index} className="destination-item view-destination">
                                ...
                                <div className="no-destinations">No destinations added to this itinerary.</div>
                            )}
                        </div>
                    </div>
                </div>
